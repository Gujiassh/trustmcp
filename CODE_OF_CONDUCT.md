...
maintainers through the reporting path described in [SECURITY.md](./SECURITY.md)
or by opening an issue that requests a private contact path without sharing
